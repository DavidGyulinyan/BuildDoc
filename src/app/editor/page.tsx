        ...
        <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Խմբագրեք փաստաթղթի դաշտերը և տեսեք փոփոխությունները իրական
              ժամանակում
            </p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg overflow-y-auto max-h-[calc(100vh-280px)]">
            <h2 className="text-xl font-semibold mb-4 text-blue-600">
              Խմբագրել փաստաթղթի տվյալները
            </h2>

            {/* Document Info */}
            <div className="mb-6">
              <h3 className="font-semibold mb-2 text-gray-700 border-b pb-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateCurrentPage({
                        documentInfo: {
                          ...documentInfo,
                          performativeNumber: parseInt(e.target.value) || 0,
                        },
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div className="mb-6">
              <h3 className="font-semibold mb-2 text-gray-700 border-b pb-2">
                Տեխնիկական հսկողության ընկերություն
              </h3>
              <div className="space-y-3">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-700">
                    ...
                    onChange={(e) =>
                      setCompanies({
                        ...
                        technicalControlCompany: {
                          ...companies.technicalControlCompany,
                          name: e.target.value,
                        },
                      })
                    }
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCompanies({
                          ...
                          technicalControlCompany: {
                            ...companies.technicalControlCompany,
                            technicalControlEngineer: e.target.value,
                          },
                        })
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCompanies({
                          ...
                          generalContractor: {
                            ...companies.generalContractor,
                            generalEngineer: e.target.value,
                          },
                        })
                      }
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-700">
                    Պատասխանատու անձի պաշտոն
                  </label>
                  <input
                    type="text"
                    value={
                      companies.generalContractor.responsiblePersonPosition
                    }
                    onChange={(e) =>
                      setCompanies({
                        ...companies,
                        generalContractor: {
                          ...companies.generalContractor,
                          responsiblePersonPosition: e.target.value,
                        },
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              <div className="space-y-3 py-2">
                <div>
                  ...
                  <input
                    type="text"
                    value={companies.foreman.name}
                    onChange={(e) =>
                      setCompanies({
                        ...companies,
                        foreman: { ...companies.foreman, name: e.target.value },
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={
                      companies.subContractor.subContractorResponsiblePerson
                    }
                    onChange={(e) =>
                      setCompanies({
                        ...companies,
                        subContractor: {
                          ...companies.subContractor,
                          subContractorResponsiblePerson: e.target.value,
                        },
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCompanies({
                        ...
                        copyrightControl: {
                          ...companies.copyrightControl,
                          copyrightControlResponsiblePerson: e.target.value,
                        },
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div className="mb-6">
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-700">
                  Շինարարական նորմերի կարգավիճակ
                </label>
                <input
                  type="text"
            ...
            <div className="mb-6 bg-blue-50 p-4 rounded-lg">
              <h3 className="font-semibold mb-3 text-blue-700 border-b border-blue-200 pb-2">
                Էջի հատուկ տվյալներ
              </h3>
              <div className="space-y-3">
                <div>
                  ...
                  <textarea
                    value={natureOfWork}
                    onChange={(e) =>
                      updateCurrentPage({ natureOfWork: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    rows={2}
                  />
                ...
                <div>
                  ...
                  <textarea
                    value={materials}
                    onChange={(e) =>
                      updateCurrentPage({ materials: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    rows={2}
                  />
                ...
                <div>
                  ...
                  <textarea
                    value={permittedToDo}
                    onChange={(e) =>
                      updateCurrentPage({ permittedToDo: e.target.value })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    rows={2}
                  />
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={permittedToDoHeightSign}
                    onChange={(e) =>
                      updateCurrentPage({
                        permittedToDoHeightSign: e.target.value,
                      })
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
